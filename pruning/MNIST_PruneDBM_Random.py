...
def main(perc_l1=10, perc_l2=10, n_sessions=10, random_seed=None, initial_model_path=None, 
    ...
    model_path = os.path.join('..', 'models', 'MNIST', f'seed{random_seed}', 'frandom_{perc_l1}perc_{perc_l2}perc_{n_sessions}sessions_{MAX_EPOCH}epoch_{batch}batch)
    ...
    for it in range(n_iter):                   
        ...
        print("Randomly prune ", THR_L1, "percentile of weights.")
        ...
        selected_10_percent = np.random.choice(indices_that_still_exist, n_10_percent, replace=False)
        ...
        print("Randomly prune ", THR_L2, "percentile of weights.")
