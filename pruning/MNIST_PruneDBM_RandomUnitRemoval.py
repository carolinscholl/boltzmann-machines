...
def main(perc_l1=10, perc_l2=10, n_sessions=10, random_seed=None, initial_model_path=None, 
    ...
    model_path = os.path.join('..', 'models', 'MNIST', f'seed{random_seed}_june', f'random_unit_{perc_l2}perc_{n_sessions}sessions_{batch}batch')
...
if __name__ == '__main__':
    ...
    main(args.percentile_l1, args.percentile_l2, args.n_pruning_session, args.seed, initial_model_path, batch=args.batch)
